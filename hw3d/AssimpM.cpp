...
AssimpM::AssimpM(Graphics& gfx, std::mt19937& rng,
	...
	TestObject(gfx, rng, adist, ddist, odist, rdist)
{
	...
	if (!IsStaticInitialized())
	{
		...
		hw3dexp::VertexBuffer vbuf(
			std::move(VertexLayout{}.Append(VertexLayout::Position3D).Append(VertexLayout::Normal))
		);
		...
		AddStaticIndexBuffer(std::make_unique<IndicesBuffer>(gfx, indices));
